...
public class V1__Database_scheme_initialization implements SpringJdbcMigration, MigrationInfoProvider {
  ...
  public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
    ...
    jdbcTemplate.execute("create table program (id bigint generated by default as identity (start with 1), active boolean not null, date_of_issue timestamp, discount float8, program_template_id bigint, schedule_id bigint, primary key (id))");
    ...
    jdbcTemplate.execute("create table tarif (id bigint generated by default as identity (start with 1), date_of_issue timestamp, description varchar(255), name varchar(255) not null, value float8, primary key (id))");
