...
public class V1__Database_scheme_initialization implements SpringJdbcMigration, MigrationInfoProvider {
  ...
  public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
    ...
    jdbcTemplate.execute("create table class_instance_attendent (class_instance_id bigint not null, attendent_id bigint not null)");
    ...
    jdbcTemplate.execute("alter table class_instance_attendent add constraint FK_bmht1dr9piiplh214xsxcv7tw foreign key (attendent_id) references attendant");
    jdbcTemplate.execute("alter table class_instance_attendent add constraint FK_e09rm16qoosodcvwamyph12re foreign key (class_instance_id) references class_instance");
